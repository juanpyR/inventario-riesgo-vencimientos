...
def mostrar_inventario_nuevo(df_riesgo, total_riesgo, fecha_hoy, df_con_meses=None):
    ...
    with col2:
        ...
        if st.session_state.get('plan_aceptado', False):
            ...
            # Timeline compacto
            st.markdown("### ⏰ Timeline 48H")
            col_a, col_b = st.columns(2)
            with col_a:
                st.info("**🔴 HOY 08:00-12:00**\n\n• Generar acta donación\n• Contactar fundación\n• Imprimir etiquetas 40%\n• Ubicar críticos en entrada")
            with col_b:
                st.info("**🟡 MAÑANA 14:00-18:00**\n\n• Imprimir etiquetas 25%\n• Monitorear ventas\n• Fotografía góndolas\n• Reporte final")
            
            # Puntos críticos simplificados
            st.warning("**⚠️ Puntos Críticos:** Documentar donaciones • Monitorear cada 4h • Stock no vendido → Preventivo • Evidencia fotográfica")
...
def mostrar_plan_accion(df_riesgo, fecha_hoy):
        ...
        <div class="plan-section plan-vencido">
            ...
            <div class="action-list">
                <div class="action-item" style="border-color: #4caf50;">
                    ...
                    <span class="action-text"><strong>Generar acta de donación</strong> - Crédito tributario Ley 19.885</span>
                </div>
            </div>
        ...
        <div class="plan-section plan-critico">
            ...
            <div class="action-list">
                <div class="action-item" style="border-color: #f57c00;">
                    ...
                    <span class="action-text"><strong>Markdown 40%</strong> - Reposición prioritaria en entrada principal</span>
                </div>
            </div>
        </div>
        """), unsafe_allow_html=True)
    ...
    escenarios = {
        ...
        'Conservador': {'factor': 0.85, 'color': '#f57c00', 'label': '🟡 Conservador (-15%)'},
        'Base': {'factor': 1.0, 'color': '#4caf50', 'label': '✅ Escenario Base'},
